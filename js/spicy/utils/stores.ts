// Adapted from Spicy Lyrics src/utils/stores.ts (see ../../ATTRIBUTION.md).
// Only change: Spicetify.LocalStorage -> window.localStorage and the
// Spicetify-injected version constant -> a static string. All atoms identical.
...
export const $spicyLyricsVersion = atom<string>("mono-port");
